...
export class NumberSpace {
  ...
  private calculateUnconstrainedUniverse(): TypeSpaceRegion[] {
    return [
      ...
      },
      {
        ...
        type: { kind: 'primitive', name: 'number' },
        constraints: [
          this.createRangeConstraint(-Infinity, Number.MIN_SAFE_INTEGER - 1)
        ],
      ...
      },
      {
        ...
        type: { kind: 'primitive', name: 'number' },
        constraints: [
          this.createRangeConstraint(Number.MIN_SAFE_INTEGER, -1)
        ],
        cardinality: 'infinite'
      },
      {
        ...
        type: { kind: 'primitive', name: 'number' },
        constraints: [
          this.createRangeConstraint(0, 0)
        ],
        cardinality: 1
      },
      {
        ...
        type: { kind: 'primitive', name: 'number' },
        constraints: [
          this.createRangeConstraint(1, Number.MAX_SAFE_INTEGER)
        ],
        cardinality: 'infinite'
      },
      {
        ...
        type: { kind: 'primitive', name: 'number' },
        constraints: [
          this.createRangeConstraint(Number.MAX_SAFE_INTEGER + 1, Infinity)
        ],
        cardinality: 'infinite'
      }
    ];
  ...
  private calculateConstrainedUniverse(
    rangeConstraints: TypeConstraint[]
  ): TypeSpaceRegion[] {
