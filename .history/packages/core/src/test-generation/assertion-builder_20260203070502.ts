...
export class AssertionBuilder {
  ...
  buildAssertion(
    ...
    const code = this.generateAssertionCode(
      testCase,
      framework,
      assertionType,
      options
  ...
  private generateAssertionCode(
    ...
    if (framework === 'jest' || framework === 'vitest') {
      return this.generateExpectAssertion(
        functionCall,
        testCase,
        assertionType,
        options
      ...
      return this.generateAssertAssertion(
        functionCall,
        testCase,
        assertionType,
        options
  ...
  private generateExpectAssertion(
    ...
    switch (assertionType) {
      ...
      case 'special-value':
        return this.generateSpecialValueAssertion(
          functionCall,
      ...
      case 'type-check':
        return this.generateTypeCheckAssertion(
          functionCall,
          testCase.expectedValue,
          'expect'
        );
      ...
      case 'predicate':
        return this.generatePredicateAssertion(
          functionCall,
          testCase.expectedValue,
          'expect'
        );
